...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, chatName: string, latestThread?: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null };

export type ThreadFragmentFragment = { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } };
...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, chatName: string, latestThread?: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null } };

export type GetChatsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, chatName: string, latestThread?: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null }> };
...
export type GetChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, chatName: string, latestThread?: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } | null } };
...
export type CreateThreadMutation = { __typename?: 'Mutation', createThread: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } };
...
export type GetThreadsQuery = { __typename?: 'Query', threads: Array<{ __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } }> };
...
export type OnThreadCreatedSubscription = { __typename?: 'Subscription', onThreadCreated: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string } } };
...
export const OnThreadCreatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"onThreadCreated"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"chatId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"onThreadCreated"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"chatId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"chatId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ThreadFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ThreadFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Thread"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"chatId"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}}]}}]} as unknown as DocumentNode<OnThreadCreatedSubscription, OnThreadCreatedSubscriptionVariables>;