...
export type ThreadFragmentFragment = { __typename?: 'Thread', _id: string, content: string, createdAt: any };
...
export type GetThreadsQuery = { __typename?: 'Query', threads: Array<{ __typename?: 'Thread', _id: string, content: string, createdAt: any }> };
