...
export type ThreadFragmentFragment = { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, userId: string };
...
export type CreateThreadMutation = { __typename?: 'Mutation', createThread: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, userId: string } };
...
export type GetThreadsQuery = { __typename?: 'Query', threads: Array<{ __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, userId: string }> };
...
export type OnThreadCreatedSubscription = { __typename?: 'Subscription', onThreadCreated: { __typename?: 'Thread', _id: string, content: string, createdAt: any, chatId: string, userId: string } };
